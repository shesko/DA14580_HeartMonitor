...
#if (BLE_APP_HT)
    #define APP_CFG__APPEARANCE 728
#else
    #define APP_CFG__APPEARANCE 0x0000
#endif
// Slave preferred Minimum of connection interval
#define APP_CFG_CON_INTV_MIN   8       // 10ms (8*1.25ms)
// Slave preferred Maximum of connection interval
#define APP_CFG_CON_INTV_MAX   16      // 20ms (16*1.25ms)
// Slave preferred Connection latency
#define APP_CFG_CON_LATENCY    0
// Slave preferred Link supervision timeout
#define APP_CFG_SUPERV_TO      100
// Privacy settings bit field
#define APP_CFG_FLAGS          0
